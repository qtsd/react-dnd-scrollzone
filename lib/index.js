...
function createScrollingComponent(WrappedComponent, itemTypes) {
  ...
  function (_Component) {
    ...
    function ScrollingComponent(props, ctx) {
      ...
      _this.scaleY = 0;
      _this.frame = null;
      _this.updateScrolling = (0, _lodash.default)(_this.updateScrolling, 100, {
        trailing: false
      });
      return _this;
    }
    ...
    _proto.updateScrolling = function updateScrolling(coords) {
      ...
      this.scaleY = this.props.verticalStrength(box, coords); // start scrolling if we need to
